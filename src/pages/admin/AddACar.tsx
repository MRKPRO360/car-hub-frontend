...
const fuelTypeOptions: TFuelType[] = [
  'Petrol',
  'Diesel',
  'Electric',
  'Hybrid',
...
const transmissionOptions: TTransmission[] = ['Automatic', 'Manual'];

const conditionOptions: TCondition[] = ['New', 'Used', 'Certified Pre-Owned'];
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select
              ...
              `}
              {...register('category', {
                required: 'A car should have a category!',
              })}
            >
