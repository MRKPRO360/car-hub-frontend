...
import { useDeleteAnOrderMutation } from '../../redux/features/admin/orderManagement.api';
              ...
              <tbody>
                {paginatedData.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="p-1">{item?.user?.name}</td>
                    <td className="p-1">{item?.user?.email}</td>
                    <td
                    ...
                    <td className="p-1 font-semibold">{item?.user?.phone}</td>
                    <td className="p-1 font-semibold">{item?.user?.phone}</td>
