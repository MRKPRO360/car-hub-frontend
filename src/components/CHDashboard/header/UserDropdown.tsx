...
export default function UserDropdown({
  ...
  return (
    <div className="relative " ref={dropdownRef}>
      ...
      >
        <img
          src={user?.profileImg || `https://readymadeui.com/profile_6.webp`}
      ...
      {isOpen && (
        <ul className="absolute -left-[50%] transform translate-x-[20%] block  bg-white rounded-lg drop-shadow-[0_8px_8px_rgba(37,99,235,0.05)] hover:drop-shadow-[0_8px_4px_rgba(37,99,235,0.1)] transition duration-300 z-[1000] min-w-full w-max  max-h-96 overflow-auto">
          <Link
